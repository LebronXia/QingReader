...
public class WelfareAdapter extends CommonAdapter<GankIoDataBean.ResultBean>{
    public WelfareAdapter(Context context, int layoutId, List<GankIoDataBean.ResultBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    public void convert(ViewHolder holder, GankIoDataBean.ResultBean resultBean) {
        holder.setImageUrl(R.id.iv_gank_walfare, resultBean.getUrl());
    }
